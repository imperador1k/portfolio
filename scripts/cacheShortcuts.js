...
const result = getAllShortcuts(PUBLIC_DIR);
console.log("Generated shortcut data:", JSON.stringify(result, null, 2));
...
console.log("Shortcut cache written successfully");