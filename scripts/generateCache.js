...
try {
  const shortcuts = getAllShortcuts(PUBLIC_DIR);
  writeFileSync(
    "./public/.index/shortcutCache.json",
    JSON.stringify(shortcuts)
  );
  console.log("Shortcut cache generated successfully!");
  console.log("Found shortcuts:", Object.keys(shortcuts["/Users/Public/Desktop"] || {}));
} catch (error) {
  console.error("Error generating shortcut cache:", error);
}